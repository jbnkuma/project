...
$centerLogin="Iniciar Sesión";
$centerPleasewait="Espera un momento.......";
$centerLogout="Salir de la sesión";
$h1Login="$ChilliSpot Iniciar Sesión";
$h1Failed="$ChilliSpot Inicio de sesión  Fallido";
